...
{{--                        <p class="text-xs text-gray-500 dark:text-gray-400">SKU: {{ substr($cartItem['sku'],4) }}...</p>--}}
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            $ {{ number_format($cartItem['price'], 2) }} </p>
                    </div>

                    <div class="flex items-center space-x-2">
                        <input type="number" min="1" wire:change="updateQty({{$cartItem['id']}} , $event.target.value )"
